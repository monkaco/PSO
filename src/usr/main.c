...
int main(void)
{
	...
	PSO_GPIOConfig();
	PSO_UART0Config();
	PSO_Timers(); /* Timer initialization */
	PSO_ADCConfig();
	pso_rpm_config();
	pso_pwm_config();
...
//	g_pso_data.accel[0] = 110;	/* x-axis vibration */
//	g_pso_data.accel[1] = 115;  /* y-axis vibration */
//	g_pso_data.accel[2] = 120;  /* z-axis vibration */
//	g_pso_data.rpm = 1750U;     /* Revolutions per minute */
//	g_pso_data.i_motor = 17*100;    /* Current of the motor, [A] */
//	g_pso_data.v_motor = 11.6*100;  /* Voltage applied to the motor, [V] */
//	g_pso_data.thrust = 23*100;     /* Force generated by the motor + propeller, [N] */
