...
src/usr/main.obj: ../src/usr/main.c $(GEN_OPTS) $(GEN_HDRS)
	...
	"C:/ti/ccsv6/tools/compiler/ti-cgt-arm_5.2.5/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me --include_path="C:/ti/ccsv6/tools/compiler/ti-cgt-arm_5.2.5/include" --include_path="C:/ti/TivaWare_C_Series-2.1.0.12573--" --include_path="D:/Dropbox/myShared/Engenharia/Codigos/Tiva-C/PSO/inc/sys" --include_path="D:/Dropbox/myShared/Engenharia/Codigos/Tiva-C/PSO/inc/usr" --include_path="D:/Dropbox/myShared/Engenharia/Codigos/Tiva-C/PSO/inc/usr/ulink" -g --define=PART_TM4C123GH6PM --define=TARGET_IS_BLIZZARD_RB1 --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="src/usr/main.pp" --obj_directory="src/usr" $(GEN_OPTS__FLAG) "$<"
